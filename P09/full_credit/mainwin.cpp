...
Mainwin::Mainwin() {
    ...
    //         N E W   G R A D E
    // Append New Grade to the Insert menu
    Gtk::MenuItem *menuitem_new_grade = Gtk::manage(new Gtk::MenuItem("New _Grade", true));
   ...
   // Add a little space 
    ...
    Gtk::Image* student_image = Gtk::manage(new Gtk::Image{"button1_st.png"});
    ...
    Gtk::Image* parent_image = Gtk::manage(new Gtk::Image{"button2_pt.png"});
    ...
    Gtk::Image* ps_relate_image = Gtk::manage(new Gtk::Image{"button3_rl.png"});
   ...
   // Add a little space 
    ...
    Gtk::Image* course_image = Gtk::manage(new Gtk::Image{"button5_c.png"});
    ...
    Gtk::Image* section_image = Gtk::manage(new Gtk::Image{"button6_sec.png"});
    ...
    Gtk::Image* teacher_image = Gtk::manage(new Gtk::Image{"button7_t.png"});
    ...
    Gtk::Image* transcript_image = Gtk::manage(new Gtk::Image{"button8_tra.png"});
    ...
    //    N E W   G R A D E
    // Add a custom New Grade icon
    Gtk::Image* grade_image = Gtk::manage(new Gtk::Image{"button9_g.png"});
    Gtk::ToolButton *grade_button = Gtk::manage(new Gtk::ToolButton(*grade_image));
    grade_button->set_tooltip_markup("Create a new grade");
...
void Mainwin::on_new_school_click() {
    ...
    for(Transcript* s : transcripts) delete s;
    transcripts.clear();
...
// Returns index of selected teacher, or -1 for Cancel / Close
