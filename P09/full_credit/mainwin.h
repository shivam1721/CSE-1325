...
enum class View {SAME, STUDENTS, PARENTS, TEACHERS, COURSES, SECTIONS, TRANSCRIPT};
...
class Mainwin : public Gtk::Window {
    ...
    protected:
        ...
        void on_new_transcript_click();  // Create a new transcrpit
        void on_set_grade_click();       // Set grade
